  ...
  <div id="tab1" class="tabson">
    <ul class="forminfo">
      ...
      <li  style="margin-top:20px;"> 
        ...
        <div class="vocation">
          <input name="rName" type="text" class="dfinput" value="客户姓名"  style="width:344px;"/>
        </div>
      </li>
      <br /> <br />
      <li>
      ...
      <li>
        ...
        <div class="vocation">
          <input name="RRice"  id="yajin" type="text" class="dfinput" value="押金"  style="width:344px;"/>
        </div>
      </li> <br />
       <li>
        <label for="qita" style="cursor:pointer" >其他消费<b>*</b></label>
        <div class="vocation">
          <input name="otherPrice"  id="qita" type="text" class="dfinput" value=""  style="width:344px;"/>
        </div>
      </li> <br />
      <li>
        <label for="date1" style="cursor:pointer" >入住时间<b>*</b></label>
        <div class="vocation">
          <input name="rtime"  id="date1" class="dfinput" value="2016-06-01"  style="width:344px;"/>
        </div>
      </li> <br />
      <li>
