...
<div class="divAdd" align="center">
		<form name="dataFrm" id="dataFrm" action="/airquality/addair" method="post">
			<table  cellpadding="1" cellspacing="1" class="admin-list"  border="1">
				<tr>
				<td colspan="3" style="text-align: center;"><h2>更新电子文档</h2></td>
				</tr>

				<tr>
					<td style="text-align: right;" class="text_tabledetail2">文档编号：</td>
					<td><div><span id="id">？？</span></div></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<tr>
						<td style="text-align: right;" class="text_tabledetail2">当前修改时间：</td>
