    ...
    <div class="toolbar1" align="center">
        <table>
            <form method="post" name="serch" action="/airquality/list">
                <tr>
                    <td class="zi"><span>文档分类:</span><input type="hidden" value="${choose}"></td>
                    <td><select name="choose">
                        <option value="0">全部文档</option>
						<option value="1" <c:if test="${choose==1}">selected="selected"</c:if>>文档类型1</option>
						<option value="2" <c:if test="${choose==2}">selected="selected"</c:if>>文档类型2</option>
						<option value="3" <c:if test="${choose==3}">selected="selected"</c:if>>文档类型3</option>
						<option value="4" <c:if test="${choose==4}">selected="selected"</c:if>>文档类型4</option>
						<option value="5" <c:if test="${choose==5}">selected="selected"</c:if>>文档类型5</option>
						<option value="6" <c:if test="${choose==6}">selected="selected"</c:if>>文档类型6</option>
                    </select></td>
                  <%-- <td class="zi"><span>关键字：</span></td>
                    <td><input name="likes" type="text" placeholder="与分类关联" value=""/></td>--%>
                    <td><input type="submit" value="查询" class="button"/></td>
                    <td><a href="/airquality/add"><input type="button" value="新增电子文档" class="button2"/></a></td>
                </tr>
            </form>
        </table>
    </div>
		...
		<th align="center"  colspan="6"><h1>电子文档列表</h1></th>
		</tr>
		</thead>
